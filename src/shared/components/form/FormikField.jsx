...
function FormikField({
  ...
  return (
    ...
    <>
      {type === 'password' ? (
        <div className={`${styles.formGroup} my-2`} style={{ maxWidth: fullWidth ? '100%' : '400px' }}>
          <input
            type={showPassword ? 'text' : 'password'}
            name={name}
            className={`${styles.customPasswordField} ${styles.commonFieldStyles} ${className}`}
        ...
        <div className={`${styles.formGroup}`} style={{ maxWidth: fullWidth ? '100%' : '400px' }}>
          <div className="position-relative">
            <input
              ...
              name={name}
              disabled={disabled}
              className={`${styles.customPriceField} ${styles.commonFieldStyles} w-100 ${className}`}
              placeholder={placeholder}
              style={{ borderColor: error && touched ? 'red' : '#e3d6d1' }}
              value={innerValue}
              onChange={handleChange}
        ...
        <div className={`${styles.formGroup}`} style={{ maxWidth: fullWidth ? '100%' : '400px' }}>
          <textarea
            ...
            type="text"
            name={name}
            className={`${styles.customTextField} ${styles.commonFieldStyles} w-100 ${className}`}
            placeholder={placeholder}
        ...
        <div className={`${styles.formGroup}`} style={{ maxWidth: fullWidth ? '100%' : '400px' }}>
          <div className="position-relative">
            <input
              ...
              name={name}
              disabled={disabled}
              className={`${styles.customDaysField} ${styles.commonFieldStyles} w-100 ${className}`}
              placeholder={placeholder}
              style={{ borderColor: error && touched ? 'red' : '#e3d6d1' }}
              value={innerValue}
              onChange={handleChange}
